    ...
    class Vehicle : MobileObject
    {
        ...
        //Print method that overrides parent class method: prints out the information of the Vehicle object in question
           public override void  printObject()
            {
               Console.Out.WriteLine("Name: " + Name + " ID: " + ID1 + " Position:  " + Position.X + ", " + Position.Y + ", " + Position.Z + " Position Cell ID: " + PositionCell + " Height: " + height + " Length: " + length + " Width: " + width + " Mass: " + mass + " Number of wheels: " + numWheels + " Bounding Volume: " + boundingVolume);
            }
