...
namespace Assignment1
{
    ...
    class NPC : MobileObject
    {
        ...
        {
           Console.Out.WriteLine("Name: " + Name + " ID: " + ID1 + " Position:  " + Position.X + ", " + Position.Y + ", " + Position.Z + " Position Cell ID: " + PositionCell + " Torso Length: " + torsoLength + " Head Height: " + headHeight + " Leg Length: " + legLength + " Arm Length: " + armLength + " Mass: " + mass + " Total Height: " + totalHeight );
        }
